...
class CartDetails extends BaseModel
{
    ...
    public static function getCartItemsByAccount($id)
    {
        ...
        $query = "
            SELECT CD.id as cartDetailId, PD.id, PD.sku, P.name, PD.price, C.name as colorName, I.path_url as pathUrl, S.name as sizeName, PD.quantity as stock, CD.quantity, CD.created_at as createdAt
